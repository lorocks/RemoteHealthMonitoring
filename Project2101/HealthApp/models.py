...
class UserType(models.Model):
    Type = [("Doctor"), ("Patient")]
    userID = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete = models.CASCADE, primary_key = True)
    username = models.ForeignKey(UserIDs, on_delete = models.CASCADE)
    userType = models.CharField(max_length = 7, choices = Type, null = False)
...
class SecondlyData(models.Models):
    PatientID = models.ForeignKey(Patients, on_delete = models.CASCADE)
    Date = models.DateField(null=False, blank=False)
